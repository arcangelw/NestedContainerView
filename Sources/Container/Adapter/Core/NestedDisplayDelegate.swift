...
/// 默认实现
extension NestedDisplayDelegate {
    /// 控制器即将展示
    ///
    /// - Parameters:
    ///   - nestedAdapter: 当前适配器
    ///   - sectionController: 当前控制器
    public func nestedAdapter(_ nestedAdapter: NestedAdapter, willDisplay sectionController: NestedSectionController) {}
    ...
    ///   - nestedAdapter: 当前适配器
    ///   - sectionController: 当前控制器
    public func nestedAdapter(_ nestedAdapter: NestedAdapter, didEndDisplaying sectionController: NestedSectionController) {}
    ...
    ///   - contentView: 内容视图
    ///   - sectionController: 当前控制器
    public func nestedAdapter(_ nestedAdapter: NestedAdapter, willDisplay contentView: UIView, for sectionController: NestedSectionController) {}
    ...
    ///   - contentView: 内容视图
    ///   - sectionController: 当前控制器
    public func nestedAdapter(_ nestedAdapter: NestedAdapter, didEndDisplaying contentView: UIView, for sectionController: NestedSectionController) {}
    ...
    ///   - headerView: headerView视图
    ///   - sectionController: 当前控制器
    public func nestedAdapter(_ nestedAdapter: NestedAdapter, willDisplayHeaderView headerView: UIView, for sectionController: NestedSectionController) {}
    ...
    ///   - headerView: headerView视图
    ///   - sectionController: 当前控制器
    public func nestedAdapter(_ nestedAdapter: NestedAdapter, didEndDisplayingHeaderView headerView: UIView, for sectionController: NestedSectionController) {}
    ...
    ///   - headerView: footerView视图
    ///   - sectionController: 当前控制器
    public func nestedAdapter(_ nestedAdapter: NestedAdapter, willDisplayFooterView footerView: UIView, for sectionController: NestedSectionController) {}
    ...
    ///   - headerView: footerView视图
    ///   - sectionController: 当前控制器
    public func nestedAdapter(_ nestedAdapter: NestedAdapter, didEndDisplayingFooterView footerView: UIView, for sectionController: NestedSectionController) {}
}
